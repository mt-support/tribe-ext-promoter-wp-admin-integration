...
class Plugin extends \tad_DI52_ServiceProvider {
	 ...
	 * @var string
	 */
	const FILE = TRIBE_EXTENSION_PROMOTER_WP_ADMIN_INTEGRATION_FILE;
	...
	public function register() {
		...
		$this->container->singleton( 'extension.promoter_wp_admin_integration', $this );
	...
	protected function register_plugin_dependencies() {
		...
		$this->container->singleton( 'extension.promoter_wp_admin_integration', $plugin_register );
	}
}
